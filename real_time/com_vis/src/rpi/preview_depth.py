...
def run_depth_sensor():
    ...
    while True:
        ...
        if frame is not None and isinstance(frame, ac.DepthData):
            ...
            cv2.normalize(confidence_buf, confidence_buf, 255, 0, cv2.NORM_MINMAX)

            #cv2.imshow("preview_confidence", cv2.normalize(confidence_buf,None, 1,0,cv2.NORM_MINMAX))
            ...
            yield depth_buf/1000, confidence_buf # returns the depth (in meters)
